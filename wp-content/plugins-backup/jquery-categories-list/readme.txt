...
= Features =
 ...
 1. Shortcode support  *[jQuery Categories List]*
...
1. Go to Presentation -> Widgets and drag the jQuery Categories List to your sidebar and configure it, if you want to display it inside a post then write [jQuery Categories List] at the location where it will be shown and save it.
...
Yes, only write [jQuery Categories List] anywhere inside a post or page's contest and it will be
...
Since 1.2 there's a trick to do it, just add a new Text widget only with  [jQuery Categories List] as content (without quotes) then
